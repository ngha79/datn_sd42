...
public class BannerServiceImpl implements BannerService {
    ...
    @Override
    public Page<BannerResponse> getBanners(Banner.BannerPosition position, Boolean isActive, Pageable pageable) {
        return bannerRepository.findByPositionAndIsActive(position, isActive, pageable).map(banner -> modelMapper.map(banner, BannerResponse.class));
    }
    ...
    public BannerResponse createBanner(BannerCreateRequest request,
        ...
        imageUploadProducer.sendUploadMessage(
                ImageUploadBannerMessage.builder()
                        ...
                        .action(ImageUploadBannerMessage.ActionType.CREATE)
                        .build()
        );
