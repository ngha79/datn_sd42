...
public class ChatController {
    ...
    public ResponseEntity<ApiResponse<ConversationResponse>> createConversation(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(chatService.createConversation(request, file)));
    }
    ...
    public ResponseEntity<ApiResponse<Page<ConversationResponse>>> getAllConversations(
        ...
        Pageable pageable = PageRequest.of(page, size);
        return ResponseEntity.ok(ApiResponse.success(
                chatService.getAllConversations(status, pageable)));
    }
    ...
    public ResponseEntity<ApiResponse<ConversationResponse>> reassignStaff(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                chatService.reassignStaff(conversationId, staffId)));
    }
    ...
    public ResponseEntity<ApiResponse<Page<MessageResponse>>> getMessages(
        ...
        Pageable pageable = PageRequest.of(page, size);
        return ResponseEntity.ok(ApiResponse.success(
                chatService.getMessages(conversationId, pageable)));
    }
    ...
    public ResponseEntity<ApiResponse<MessageResponse>> sendMessage(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(chatService.sendMessage(request, file)));
    }
